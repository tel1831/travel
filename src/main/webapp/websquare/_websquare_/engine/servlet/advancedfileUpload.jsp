...
<script language="JavaScript">
	...
	function doInit() {
        ...
        try {
			...
			Upload_file_title = opener.WebSquare.language.getMessage( "Upload_file_title" ) || "파일 업로드";
			Upload_file_header = opener.WebSquare.language.getMessage( "Upload_file_header" ) || "파일 업로드";
			Upload_file_choose = opener.WebSquare.language.getMessage( "Upload_file_choose" ) || "파일 선택";
			Upload_file_span = opener.WebSquare.language.getMessage( "Upload_file_span" ) || "선택된 파일 없음";
			...
			Upload_msg18 = opener.WebSquare.language.getMessage( "Upload_msg18" ) || "쓰기 전용 파일이거나 읽을수 없는 파입니다.";
...
<form name="__uploadForm__" method="post" action="" enctype="multipart/form-data" target="__targetFrame__">
	...
	<div class="wrap">
		...
		<div class="content">
			<div class="filebox">
				<button type="button" id="choose_file">파일 선택</button>
				<span class="fileName" id="choose_span">선택된 파일 없음</span>
