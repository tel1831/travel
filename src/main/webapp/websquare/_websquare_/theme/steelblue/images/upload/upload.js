/* /websquare_git/websquare/_websquare_/theme/steelblue/images/upload/upload.xml 20210421.152628 22094 9a6300aa3b53b96f91c2a2a5f9b8a3f57731344ed3813f75fa0b27148efa72e9 */
export default {E:[{T:1,N:'html',A:{xmlns:'http://www.w3.org/1999/xhtml','xmlns:ev':'http://www.w3.org/2001/xml-events','xmlns:w2':'http://www.inswave.com/websquare','xmlns:xf':'http://www.w3.org/2002/xforms'},E:[{T:1,N:'head',E:[{T:1,N:'xf:model',E:[{T:1,N:'xf:instance',_xml:'<xf:instance xmlns:xf="http://www.w3.org/2002/xforms">\r\n                <data xmlns="">\r\n                	<popupParams>\r\n                		<key/>\r\n                		<fileList/>\r\n                		<fileName/>\r\n                	</popupParams>\r\n                </data>\r\n            </xf:instance>'},{T:1,N:'xf:submission',A:{action:'/websquare/delete.wq',id:'deleteFile',mediatype:'text/xml',method:'post',ref:'popupParams',replace:'none'},E:[{T:1,N:'script',A:{'ev:event':'xforms-submit-done',type:'javascript'},E:[{T:4,cdata:function(scopeObj){var $p=scopeObj["$p"];var scwin=scopeObj["scwin"];var com=scopeObj["com"];var deleteFile=scopeObj["deleteFile"];
				...
				}}]},{T:1,N:'script',A:{'ev:event':'xforms-submit-error',type:'javascript'},E:[{T:4,cdata:function(scopeObj){var $p=scopeObj["$p"];var scwin=scopeObj["scwin"];var com=scopeObj["com"];var deleteFile=scopeObj["deleteFile"];
                	WebSquare.layer.hideProcessMessage();
				}}]},{T:1,N:'script',A:{'ev:event':'xforms-submit',type:'javascript'},E:[{T:4,cdata:function(scopeObj){var $p=scopeObj["$p"];var scwin=scopeObj["scwin"];var com=scopeObj["com"];var deleteFile=scopeObj["deleteFile"];
                	WebSquare.layer.showProcessMessage( "삭제 중 입니다." );
				}}]}]}]},{T:1,N:'script',A:{type:'javascript',lazy:'false'},E:[{T:4,cdata:function(scopeObj){var $p=scopeObj["$p"];var scwin=scopeObj["scwin"];var com=scopeObj["com"];var deleteFile=scopeObj["deleteFile"];scwin.onpageload = function(){
